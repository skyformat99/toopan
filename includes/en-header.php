  ...
  <div class="navbar navbar-default">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="./"><?php echo $conf['en_title']?></a>
        </div>
        <div class="navbar-collapse collapse navbar-responsive-collapse">
          <ul class="nav navbar-nav">
            <li class="<?php echo checkIfActive('en-index,')?>"><a href="./en-US.php"><i class="fa fa-folder-open" aria-hidden="true"></i> File storage</a></li>
          ...
          <li class="<?php echo checkIfActive('admin')?>"><a href="./admin/en-login.php"><i class="fa fa-user-circle" aria-hidden="true"></i> Administrator</a></li>
