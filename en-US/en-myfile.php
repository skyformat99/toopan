...
echo '<li><a href="en-myfile.php?page='.$prev.$link.'">&laquo;</a></li>';
} else {
...
if ($page<$pages)
{
echo '<li><a href="en-myfile.php?page='.$next.$link.'">&raquo;</a></li>';
